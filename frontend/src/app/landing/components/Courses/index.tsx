...
const postData: DataType[] = [
    {
        heading: 'Configure API tokens',
        heading2: 'for social networks',
        name: "Facebook, Instagram, VK, Telegram",
            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        <h3 className="text-midnightblue text-4xl lg:text-55xl font-semibold mb-5 sm:mb-0">How it works</h3>
