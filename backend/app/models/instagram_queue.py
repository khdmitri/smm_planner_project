...
if TYPE_CHECKING:
    ...
    from .instagram_config import InstagramConfig  # Noqa
...
class InstagramQueue(Base):
    ...
    instagram_config_id: Mapped[int] = mapped_column(ForeignKey("instagramconfig.id"))
    instagram_config = relationship("InstagramConfig", back_populates="queued_posts", lazy="selectin")
